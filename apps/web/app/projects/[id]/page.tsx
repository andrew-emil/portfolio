      ...
      <section className="container mx-auto px-3 sm:px-4 py-6 sm:py-8 lg:py-10">
        <div className="grid gap-6 sm:gap-8 grid-cols-1 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="order-2 lg:order-1">
            <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-gray-800 shadow-[0_18px_40px_rgba(168,85,247,0.18)]">
              <Image
          ...
          <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-2">
              {project.technologies.map((t) => (
                <span
                  key={t}
                  className="rounded-full border border-purple-500/20 bg-purple-950/30 px-2 sm:px-3 py-1 text-xs text-purple-300"
                >
                  {t}
                </span>
              ))}
